...
public class MyStocksActivity extends AppCompatActivity implements LoaderManager.LoaderCallbacks<Cursor> {
    ...
    private static final String LOG_TAG = "stockhawk " + MyStocksActivity.class.getSimpleName();
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mTextView = (TextView) findViewById(R.id.no_stocks);
        ...
        mRecyclerView.addOnItemTouchListener(new RecyclerViewItemClickListener(this,
                new RecyclerViewItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View v, int position) {
                        ...
                        String symbol = mCursor.getString(mCursor
                                .getColumnIndex(StockHawkContract.QoutesColumns.SYMBOL));

                        Intent intent = new Intent(mContext, DetailStockActivity.class);
                        intent.putExtra(DetailStockActivity.SYMBOL, symbol);
...
//
                                    ...
                                    if (c.getCount() != 0) {
                                        Toast toast =
                                                Toast.makeText(MyStocksActivity.this,
                                                        mContext.getString(R.string.toast_symbol_repeated),
                                                        Toast.LENGTH_LONG);
    ...
    public void networkToast() {
        Toast.makeText(mContext, getString(R.string.toast_network), Toast.LENGTH_SHORT).show();
    }
    ...
    public boolean onOptionsItemSelected(MenuItem item) {
        ...
        if (id == R.id.action_change_units) {
            ...
            this.getContentResolver().notifyChange(StockHawkProvider.Quotes.CONTENT_URI, null);
        }
    ...
    public Loader<Cursor> onCreateLoader(int id, Bundle args) {
        ...
        return new CursorLoader(this, StockHawkProvider.Quotes.CONTENT_URI,
                new String[]{StockHawkContract.QoutesColumns._ID, StockHawkContract.QoutesColumns.SYMBOL, StockHawkContract.QoutesColumns.BIDPRICE,
                        StockHawkContract.QoutesColumns.PERCENT_CHANGE, StockHawkContract.QoutesColumns.CHANGE, StockHawkContract.QoutesColumns.ISUP},
